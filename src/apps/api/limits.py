...
MAX_JOURNAL_APPROVALS_PER_CYCLE = 500
DEFAULT_CLOSE_LIST_PAGE = 100
MAX_CLOSE_LIST_PAGE = 500
MAX_EVIDENCE_ROWS = 20_000
MAX_EVIDENCE_ARCHIVE_BYTES = 8 * 1024 * 1024

# Provider catalog governance keeps tenant policy and exported evidence bounded.
MAX_PROVIDER_KEY_LENGTH = 96
MAX_PROVIDER_CAPABILITIES = 16
MAX_PROVIDER_POLICY_NOTE_LENGTH = 1_000
MAX_PROVIDER_EVIDENCE_ROWS = 1_000
