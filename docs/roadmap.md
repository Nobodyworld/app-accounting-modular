...
1. Deliver issue #148 / draft PR #149 as one v0.5 Provider Author Kit tranche: standalone SDK distribution, standalone scaffold/CLI, clean-environment wheel/sdist proof, compatibility lifecycle, deterministic evidence, and explicit v0.4 operator handoff.
