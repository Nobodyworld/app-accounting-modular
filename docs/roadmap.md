...
| Provider Author Kit | Implemented for v0.5 Early Beta | The authoritative zero-runtime-dependency SDK distribution, compatibility facade, standalone scaffold/validate/build CLI, conventional typed provider project, deterministic wheel/sdist evidence, clean author/consumer harness, and allowlist-first v0.4 handoff proof are implemented in draft PR #149. | Complete exact-head local and hosted validation; keep publication, registry, marketplace, and certification out of this tranche. |
...
2. Preserve the implemented v0.5 standalone SDK/facade boundary and offline author acceptance.
