...
- 2026-08-12: Prepared the coordinated v0.2 maintenance candidate for issue #138 in draft PR #139; it remains pending review and merge. The candidate uses the verified Python 3.14.7 slim-trixie base digest, `yfinance>=0.2.44,<2.0` and locked 1.5.2 compatibility contracts, a regenerated 76-package hashed runtime graph, and the reviewed Ruff 0.16.2 patch. The generated graph retained curl-cffi 0.16.0, removed frozendict, and advanced charset-normalizer to 3.5.0 and typing-inspection to 0.4.4 as reviewed transitive outcomes.
